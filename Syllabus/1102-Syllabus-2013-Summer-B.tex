...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Regular access to your \href{http://www.outlook.com/knights.ucf.edu}{Knights Mail account}. I check my account multiple times per day and will almost always reply within 24 hours. You need to check yours \emph{at least} once per day, but preferably more frequently. (Why not set it up on your phone?)
	\end{enumerate}
	\item Recommended
	\begin{enumerate}
		\item Google account connected to your \href{http://webcourses2c.instructure.com}{Webcourses} (Canvas) account\footnote{You can connect the two using the Settings link in the top-right corner of \href{http://webcourses2c.instructure.com}{Webcourses}.}. This helps make collaboration a breeze.
...
Your grade in this course will be based on two holistic grades listed in Table~\ref{tab:assignments}. Think of these like grades for a semester-long portfolio: the components work together to build the overall value of the whole, which will be graded in this course. You will get consistent feedback throughout the semester to help ensure you are on-track for a successful grade. Additionally, each major assignment will have a specific assessment rubric, and every smaller assignment will have detailed completion guidelines that will be provided  on \href{http://webcourses2c.instructure.com}{Webcourses}.  The smaller assignments are designed to help you build skills and confidence as you work toward your final project. They should not be dismissed.
...
\begin{enumerate}
	...
	\item \textbf{You cannot pass this course unless you earn a C− on your portfolio.} In other words, a passing score (≥70 points) on your portfolio qualifies you to have your portfolio and participation scores averaged into a final grade.
\end{enumerate}
...
\section{Course Sequence}
\xentrystretch{0.25}
{\centering\footnotesize %brace balanced at end of calendar
\tablehead{\toprule\textbf{\textsc{Unit}} & \textbf{\textsc{Week}} & \textbf{\textsc{Task}} & \textbf{\textsc{Destination}}\\}
\tablelasthead{\toprule\textbf{\textsc{Unit}} & \textbf{\textsc{Week}} & \textbf{\textsc{Task}} & \textbf{\textsc{Destination}}\\}
\begin{mpxtabular}{>{\bfseries}p{0.75in}cp{2.5in}p{1.05in}} % for portrait
...
% Do not edit manually. Paste content in from Calendar Workfile. (Numbers document, this folder.)
	...
	Brainstorming	&	1	&	Syllabus Quiz, profile creation, self-introduction (discussion and/or video)	&	\href{http://webcourses2c.instructure.com}{Webcourses}/Vimeo	\\
\cmidrule(l){3-4}		&		&	\citeauthor{greene:2011aa} article response	&	\href{http://webcourses2c.instructure.com}{Webcourses}	\\
\cmidrule(l){3-4}		&		&	Topical reading responses	&	\href{http://webcourses2c.instructure.com}{Webcourses}	\\
\cmidrule(l){3-4}		&		&	Compose \& Submit Brainstorming Audit + Memo	&	GDocs; \href{http://webcourses2c.instructure.com}{Webcourses}	\\
\cmidrule(l){3-4}		&		&	\citeauthor{schurink2010importance} reading response	&	Webcourses	\\
\midrule	Planning	&	2	&	Post research question; Conference	&	Webcourses; Hangout	\\
\cmidrule(l){3-4}		&		&	Proposal peer review	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Research Proposal + Memo	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Library Modules	&	Web	\\
\cmidrule(l){3-4}		&		&	Research	&	\href{https://www.diigo.com}{Diigo}	\\
\midrule	Synthesis	&	3	&	Annotation peer review	&	Webcourses	\\
\cmidrule(l){3-4}		&		&	Research	&	Diigo	\\
\cmidrule(l){3-4}		&		&	Draft Annotated Bib	&	Diigo/GDocs	\\
\cmidrule(l){3-4}		&		&	Speed Dating “Quiz”	&	Webcourses	\\
\cmidrule(l){3-4}		&		&	Draft Framing Synthesis	&	GDocs	\\
\cmidrule(l){2-4}		&	4	&	Peer review Secondary Research Report w/ Outcomes Memo	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Submit SRR + Outcomes Memo	&	Webcourses	\\
\midrule	Genesis	&		&	Brainstorm stakeholders \& genres	&	Webcourses	\\
\cmidrule(l){3-4}		&		&	Draft stakeholder list, genre list, and data-collection tool	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Peer review lists/questions	&	GDocs	\\
\cmidrule(l){2-4}		&	5	&	Distribute surveys, schedule interviews	&	Facebook, etc.	\\
\cmidrule(l){3-4}		&		&	Write \& Peer review Stakeholder \& Genre Analyses	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Collect \& analyze data	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Write \& Peer review Data Analysis	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Submit Primary Research Report + Outcomes Memo	&	Webcourses	\\
\midrule	Analysis/Eval	&	6	&	Revise Proposal \& Conference	&	GDocs \& Hangout	\\
\cmidrule(l){3-4}		&		&	Build Pitch	&	YouTube/Vimeo	\\
\cmidrule(l){3-4}		&		&	Assemble Portfolio	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Write Course Audit	&	GDocs	\\
\cmidrule(l){3-4}		&		&	Publish	&	Tumblr	\\
...
OLD CALENDAR DATA BELOW. USED FOR MPXTAB, WHICH SUMMER TERM DOESN'T NEED
...
\tablehead{\toprule\textbf{\textsc{Unit}} & \textbf{\textsc{Week}} & \textbf{\textsc{Task}} & \textbf{\textsc{Destination}}\\}
\tablelasthead{\toprule\textbf{\textsc{Unit}} & \textbf{\textsc{Week}} & \textbf{\textsc{Task}} & \textbf{\textsc{Destination}}\\}
\begin{mpxtabular}{>{\bfseries}p{0.75in}cp{2in}p{1.25in}} % for portrait
%\begin{xtabular}{>{\bfseries}lccp{2.25in}p{3.25in}} % for landscape
\midrule
%	\toprule\textbf{\textsc{Topic(s)}} & \textbf{\textsc{Week}} &\textbf{\textsc{Class Discussion}} & \textbf{\textsc{Readings/Homework}}\\
