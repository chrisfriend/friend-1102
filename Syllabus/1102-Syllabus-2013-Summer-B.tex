...
% Do not edit manually. Paste content in from Calendar Workfile. (Numbers document, this folder.)
	...
	Brainstorming	&	1	&	Syllabus Quiz, profile creation, self-introduction (discussion and/or video)	&	Webcourses/Vimeo	\\
\cmidrule(l){3-4}		&		&	Greene article response	&	Webcourses	\\
\cmidrule(l){3-4}		&		&	Topical reading responses	&	Webcourses	\\
\cmidrule(l){3-4}		&		&	Compose \& Submit Brainstorming Audit + Memo	&	GDocs; Webcourses	\\
\cmidrule(l){3-4}		&		&	Shurink reading response	&	Webcourses	\\
...
\subsection{Changes}
    Material in the preceding schedule is subject to change at the discretion of the instructor.  Students will be notified of any changes in Webcourses. Verify your Webcourses profile notifies you appropriately.
%    \end{landscape}
