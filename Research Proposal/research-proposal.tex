...
This document is still not a formal research paper, but it needs to be rather \todo{For the love of god, pick a better word.}formally presented. Use a citation/documentation style appropriate for your given problem or question. An \textsc{mla}-formatted template is available from \todo{Really? Or just in GDocs?}Webcourses, if you want to start with more than a blank page.
